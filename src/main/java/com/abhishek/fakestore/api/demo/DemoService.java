...
public class DemoService {
	...
	public DemoObject getForObject() {
		...
		return restTemplate.getForObject(BASE_URI, DemoObject.class);
	}
	...
	public ResponseEntity<DemoObject> getForEntity() {
		...
		return restTemplate.getForEntity(BASE_URI, DemoObject.class);
	}

	public ResponseEntity<DemoObject> exchange(DemoObject demoObject) {
		...
		return restTemplate.exchange(BASE_URI, HttpMethod.GET, requestEntity, DemoObject.class);
	}

	public DemoObject postForObject() {
		...
		return restTemplate.postForObject(BASE_URI, postObjectRequest, DemoObject.class);
	}
	...
	public ResponseEntity<DemoObject> postForEntity() {
		...
		return restTemplate.postForEntity(BASE_URI, postEntityRequest, DemoObject.class);
	}
	...
	public DemoObject patchForObject() {
		// patchForObject() : Partially update an existing resource by applying HTTP
		// PATCH to the specified URL
		
		DemoObject patchRequest = new DemoObject();
		patchRequest.setName("Patch Name");
		patchRequest.setValue(300);
		return restTemplate.patchForObject(BASE_URI, patchRequest, DemoObject.class);
	}
